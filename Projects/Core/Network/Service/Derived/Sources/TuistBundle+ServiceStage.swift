...
/// Since Service-Stage is a static framework, the bundle containing the resources is copied into the final product.
    static let module: Bundle = {
        let bundleName = "Service_Service_Stage"
        ...
        fatalError("unable to find bundle named Service_Service_Stage")
    }()
}
// MARK: - Objective-C Bundle Accessor
@objc
public class ServiceStageResources: NSObject {
