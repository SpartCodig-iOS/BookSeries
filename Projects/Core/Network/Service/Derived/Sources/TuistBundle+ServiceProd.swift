...
/// Since Service-Prod is a static framework, the bundle containing the resources is copied into the final product.
    static let module: Bundle = {
        let bundleName = "Service_Service_Prod"
        ...
        fatalError("unable to find bundle named Service_Service_Prod")
    }()
}
// MARK: - Objective-C Bundle Accessor
@objc
public class ServiceProdResources: NSObject {
