...
extension Tag {
    ...
    @Tag static var coordinatorTest: Self
    @Tag static var viewActionTest: Self
    @Tag static var asyncActionTest: Self
    @Tag static var innerActionTest: Self
    @Tag static var navigationTest: Self
    @Tag static var dependencyTest: Self
